...
<a href="user.php" class="btn btn-primary mb-3">HOME</a>
    <a href="category/thai_menu.php" class="btn  mb-3" style="padding: 6px 15px; border: 2px solid #000;">เมนูอาหารไทย</a>
    <a href="category/esan_menu.php" class="btn  mb-3" style="padding: 6px 15px; border: 2px solid #000;">เมนูอาหารอีสาน</a>
    <a href="category/southern_menu.php" class="btn  mb-3" style="padding: 6px 15px; border: 2px solid #000;">เมนูอาหารใต้</a>
    <a href="category/north_menu.php" class="btn  mb-3" style="padding: 6px 15px; border: 2px solid #000;">เมนูอาหารเหนือ</a>
    </div>
