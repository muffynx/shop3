        ...
        <form action="process_order.php" method="post" enctype="multipart/form-data">
            <div class="mb-3">
                ...
                <select class="form-control" id="payment_method" name="payment_method">
                    <option value="bank1">ธนาคารกรุงไทย</option>
                    <option value="bank2">ธนาคารกสิกรไทย</option>
                    <option value="bank3">ธนาคารไทยพาณิชย์</option>
                    <option value="bank4">ธนาคารกรุงเทพ</option>
                </select>
            </div>
            <button type="submit" name="submit_order" class="btn btn-primary">ยืนยัน</button>
        </form>
    </div>
...
<div id="bankTransferForm" class="hidden container">
    ...
    <form action="process_order.php" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <img src="https://cdn.discordapp.com/attachments/634554720945438750/1161380777230086245/image.png?ex=65381722&is=6525a222&hm=9003a453996f18653e395dd478fd89a2d1d39e53259120d6af5f45dbf5412c17&" alt="QR Code" id="qrCode" class="img-thumbnail">
        </div>
        <div class="mb-3">
