...
<body>
            ...
            $sql = "SELECT * FROM products WHERE category = 'southern_menu'";
...
<a href="thai_menu.php" class="btn  mb-3" style="padding: 6px 15px; border: 2px solid #000;">เมนูอาหารไทย</a>
    <a href="esan_menu.php" class="btn  mb-3" style="padding: 6px 15px; border: 2px solid #000;">เมนูอาหารอีสาน</a>
    <a href="southern_menu.php" class="btn  mb-3" style="padding: 6px 15px; border: 2px solid #000;">เมนูอาหารใต้</a>
    <a href="north_menu.php" class="btn  mb-3" style="padding: 6px 15px; border: 2px solid #000;">เมนูอาหารเหนือ</a>
    </div>
