...
<div class="container mt-5">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <button type="submit" class="btn btn-primary" style="font-family: 'IBM Plex Sans Thai', sans-serif;">บันทึกการเปลี่ยนแปลง</button>
        <a href="profile.php" class="btn btn-danger" style="font-family: 'IBM Plex Sans Thai', sans-serif;">ยกเลิก</a>
    </form>
</div>
</body>
</html>
