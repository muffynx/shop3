...
<body>
            ...
            $sql = "SELECT * FROM products WHERE category = 'ii'";
...
<a href="../user.php" class="btn btn-primary mb-3">HOME</a>
    <a href="kk.php" class="btn  mb-3" style="padding: 6px 15px; border: 2px solid #000;">เมนูอาหารไทย</a>
    <a href="nn.php" class="btn  mb-3" style="padding: 6px 15px; border: 2px solid #000;">เมนูอาหารอีสาน</a>
    <a href="ii.php" class="btn  mb-3" style="padding: 6px 15px; border: 2px solid #000;">เมนูอาหารใต้</a>
    <a href="vv.php" class="btn  mb-3" style="padding: 6px 15px; border: 2px solid #000;">เมนูอาหารเหนือ</a>
    </div>
